...
# I had not yet discussed on the blog, so you can either choose to use the original directive
# and read about the set command in Python 3.3, or try to implement this on your own and use at least
